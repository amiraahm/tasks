...
<body>
    <form>
        <br>
        <div style='float: center;width:700px;margin: auto;'>
      ...
      echo "<tr><td class='onefr' onclick=action1('D');>DEL</td><td class='onefr' onclick=action1('^');>^</td><td class='onefr' onclick=action1('=');>=</td>";
